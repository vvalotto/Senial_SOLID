...
class Procesador(object):
    ...
    def procesar_senial(self, senial):
        ...
        """
        print("Procesando...")
        self._senial_procesada._valores = list(map(self.funcion_doble, senial.obtener_valores()))
    ...
    def procesar_senial_con_umbral(self, senial):
        ...
        self._senial_procesada._valores = list(map(self.funcion_umbral, senial.obtener_valores()))
